...
export const positionService = {
  ...
  /**
   * Create new position
   * @param {CreatePosition} positionData - Position data
   * @returns {Promise<Position>} - Created position
   */
  async createPosition(positionData: CreatePosition): Promise<Position> {
   ...
   * Update position
   * @param {string} id - Position ID
   * @param {UpdatePosition} positionData - Position data to update
   * @returns {Promise<Position>} - Updated position
   */
  async updatePosition(id: string, positionData: UpdatePosition): Promise<Position> {
