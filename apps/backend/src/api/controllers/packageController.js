...
// Fallback mock data for demonstration when database is not available
const mockPackages = [
  {
    id: '1',
    trackingNumber: 'SP12345678',
    status: 'PENDING',
    weight: 2.5,
    dimensions: {
      length: 30,
